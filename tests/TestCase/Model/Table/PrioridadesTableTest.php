...
class PrioridadesTableTest extends TestCase
{
    ...
    {
        parent::setUp();
        $config = TableRegistry::getTableLocator()->exists('Prioridades') ? [] : ['className' => PrioridadesTable::class];
        $this->Prioridades = TableRegistry::getTableLocator()->get('Prioridades', $config);
    }
